...
public class CommentListParserTest {
    private static final DerpibooruComment expectedPostedByRegisteredUser =
            new DerpibooruComment(2588576, "Silent Wing", "https://derpicdn.net/assets/no_avatar.svg",
    ...
    private static final DerpibooruComment expectedAnon =
            new DerpibooruComment(2622311, "Background Pony #FEA8", "https://derpicdn.net/assets/no_avatar.svg", "The guy next to Trixie tried to throw a tactical rock at it. \n<spoiler>\n  han solo does something in tfa \n</spoiler>",
